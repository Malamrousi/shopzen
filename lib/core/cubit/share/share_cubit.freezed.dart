...
abstract class Loading implements ShareState {
  const factory Loading({required final int productId}) = _$LoadingImpl;
...
abstract class Success implements ShareState {
