...
class _ApiService implements ApiService {
  ...
  @override
  Future<LoginResponseModel> login(Map<String, dynamic> getUser) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(getUser);
  ...
  Future<UserRoleModel> userRole() async {
    ...
    final _options = _setStreamType<UserRoleModel>(
  ...
  @override
  Future<SignUpResponseModel> signup(Map<String, dynamic> creteUser) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(creteUser);
